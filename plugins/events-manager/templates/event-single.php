...
<form action="<?php echo get_permalink(42); ?>" method="post">

<p>Your price: <input type="hidden" name="price" value="<?php echo $EM_Event->output('#_EVENTPRICERANGE'); ?>"/><br />
<?php echo $EM_Event->output('#_EVENTPRICERANGE'); ?> <br />

<?php echo $EM_Event->output('#_EVENTNAME'); ?>

<p>Your Name: <input type="hidden" name="yourname" value="<?php echo $EM_Event->output('#_EVENTNAME'); ?>"/><br />
